...
USB LTSP plugin for [Lider Ahenk project](http://www.liderahenk.org.tr).
...
3. Navigate to _lider-ahenk-usb-ltsp-plugin/scripts_ directory and run `build-plugin.sh`.
...
1. Open Eclipse, go to 'Run --> Debug Configurations' menu and on 'Plugins' tab, select _lider-console-usb-ltsp_
...
1. Create a soft link for _ahenk-usb-ltsp/usb-ltsp_ directory via `sudo ln -s lider-ahenk-usb-ltsp-plugin/ahenk-usb-ltsp/usb-ltsp/ /opt/ahenk/plugins`
